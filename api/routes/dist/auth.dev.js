...
router.post("/login", function _callee2(req, res) {
  var user, bytes, originalText, accessToken, _user$_doc, password, info;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          bytes = CryptoJS.AES.decrypt(user.password, process.env.PASS_SEC);
          ...
          res.status(200).json(_objectSpread({}, info, {
